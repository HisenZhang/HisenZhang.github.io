...
pubDate: 2019-05-07T11:10:34.000Z
tags:
  - Opera
category: Music
---
...
<script>const ap = new APlayer({
    ...
    audio: [{
        name: 'Carmen, Act IV:No.26 Marche et Choeur: Les voici! Voici le quadrille! (Choeurs/Enfants)',
        artist: 'Angela Gheorghiu,Roberto Alagna,Thomas Hampson,Michel Plasson',
        url: 'https://img.vim-cn.com/b7/c20d7dfb08014f9d7ddc9d30f640b587651116.mp2',
        cover: 'http://p1.music.126.net/PbUTTVtTVkILL1TrzVvTKw==/739971325515371.jpg?param=300x300'
    }]
});</script>

## 声部主要分类

对于Opera, 声音是其中一个重要的元素. 为了保证戏剧的代入感, 歌剧在创作的时候会规定每一个角色的声音类型, 也就是中文语境下的声部. 观察下面这张卡门的角色表. 角色的声音类型定义十分明确 (节选自[维基百科](https://en.wikipedia.org/wiki/Carmen))

| Role                             | [Voice type](https://en.wikipedia.org/wiki/Voice_type)       | Premiere cast, 3 March 1875 Conductor: [Adolphe Deloffre](https://en.wikipedia.org/wiki/Adolphe_Deloffre)[[13\]](https://en.wikipedia.org/wiki/Carmen#cite_note-D112-14) |
| -------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Carmen, *A Gypsy Girl*           | [mezzo-soprano](https://en.wikipedia.org/wiki/Mezzo-soprano) | [Célestine Galli-Marié](https://en.wikipedia.org/wiki/C%C3%A9lestine_Galli-Mari%C3%A9) |
| Don José, *Corporal of Dragoons* | [tenor](https://en.wikipedia.org/wiki/Tenor)                 | [Paul Lhérie](https://en.wikipedia.org/wiki/Paul_Lh%C3%A9rie) |
| Escamillo, *Toreador*            | [bass-baritone](https://en.wikipedia.org/wiki/Bass-baritone) | [Jacques Bouhy](https://en.wikipedia.org/wiki/Jacques_Bouhy) |
| Micaëla, *A Village Maiden*      | [soprano](https://en.wikipedia.org/wiki/Soprano)             | [Marguerite Chapuy](https://en.wikipedia.org/wiki/Marguerite_Chapuy) |
| Zuniga, *Lieutenant of Dragoons* | [bass](https://en.wikipedia.org/wiki/Bass_(voice_type))      | [Eugène Dufriche](https://en.wikipedia.org/wiki/Eug%C3%A8ne_Dufriche) |
| Moralès, *Corporal of Dragoons*  | [baritone](https://en.wikipedia.org/wiki/Baritone)           | [Edmond Duvernoy](https://en.wikipedia.org/wiki/Edmond_Duvernoy) |
...
1. [Opera 101 - Voice Type](https://www.operaphila.org/your-visit/attending-a-performance/opera-101/)

2. [维基百科](https://en.wikipedia.org/wiki/Carmen)
